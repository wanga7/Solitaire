...
export const ModalNotifyEnd = ({msg = "", onAccept, onDecline}) => {
  return (
    <NotifyBase>
      <NotifyBox>
        <p>{msg}</p>
        {onAccept ? <FormButton onClick={onAccept}>End</FormButton> : null}
        {onDecline ? <FormButton onClick={onDecline}>Continue</FormButton> : null}
      </NotifyBox>
    </NotifyBase>
  );
};
